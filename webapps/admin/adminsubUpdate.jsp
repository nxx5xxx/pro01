    ...
    <!--/헤더영역 -->
		<div class="content">
            ...
            <section class="page" id="page1">
                ...
                <form action="adminsubUpdatePro.jsp?bno=<%=bbno%>" method="post">
						<table>
						<%
							if(rs.next()){
						%>
						...
						%>
							<tr>
							<th colspan="2"><a href="adminsub2.jsp">취소</a></th><th colspan="2"><input type="submit" class="iw" value="수정"></th>
							</tr>
						</table>
				</form>
						<div class="del_wrap">
						...
						<input type="button" onclick="location.href='admindeletePro.jsp?bno=<%=bbno%>'" class="del_yes" value="삭제 확인">
						</div>
