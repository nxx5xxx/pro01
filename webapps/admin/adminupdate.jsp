	    ...
	    <div class="content" style="min-height:500px">
            ...
            <section class="page" id="page1">
                ...
                <table style="margin:0 auto" >
	                ...
	                <tr>
	                <th><a href="adminUsers.jsp" >취소</a></th>
	                <td><input type="submit" value="수정확인" ></td>
	                </tr>
                </table>
                </form>
	                <div style="text-align: center">
	                <label for="del" style="font-weight:bold; cursor:pointer">회원삭제</label>
	                <input type="checkbox" id="del" class="delon" >
		                <div class="delbox">
		                <input type="button" onclick="location.href='UserdeletePro.jsp?id=<%=mid%>'"  value="삭제에 동의합니다"  >
		                </div>
	                </div>
                </div>
            </section>
