            ...
            <section class="page" id="page1">
                ...
                <div class="page_wrap">  
					<table class="table" id="tb1">
						<thead>
							<tr>
							<th>글번호</th><th>작성자</th><th>제목</th><th>작성일</th><th></th>
							</tr>
						</thead>
						<tbody>
						<%
						...
						%>
							...
							<tr>
								...
								if(sub2id!=""){
								%>
								<td><a href="<%=path1%>/admin/adminsubDetail.jsp?bno=<%=rs.getString("bno") %>"><%=rs.getString("title") %></a></td>
								<%
								}else{
								%>
								...
								<td><input type="button" onclick="location.href='admindeletePro.jsp?bno=<%=rs.getString("bno")%>'"  value="삭제" ></td>
							</tr>
