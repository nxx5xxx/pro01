                ...
                <div class="page_wrap">
						...
						%>
							...
							<tr class="content_sub1">
								<th colspan="4"><label for="content"></label><input class="content_box" type="text" name="content" value="<%=rs.getString("content") %>"></th>
							</tr>
						...
						%>
							<tr>
							<th colspan="2"><a href="sub2.jsp">목록으로</a></th><th colspan="2"><a href="subUpdate.jsp?id=<%=rs.getString("id")%>">수정하기</a></th>
							</tr>
						</table>
